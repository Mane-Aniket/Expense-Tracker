...
[Expense-Tracker](https://github.com/Mane-Aniket/Expense-Tracker) an application where you can add all your daily expenditure and the application will give you an easy way to organize them and also give a graphical representation of how you spend!
...
```
git clone git@github.com:Mane-Aniket/Expense-Tracker.git
cd Expense-Tracker
```
